<?php
	...
	$qry_u="SELECT * FROM members WHERE username='$_SESSION[username]' && mem_id='$_SESSION[SESS_MEMBER_ID]'";
    $resul=mysql_query($qry_u);
    while($urow=mysql_fetch_array($resul)){ 
        $tid=md5($urow['mem_id']);
        $tttt=$urow['mem_id'];
        $uname=$urow['username'];
        $fulname=$urow['fulname'];
        $pppp=$urow['pp'];
        $jdate=$urow['regdate'];
        ...
        $ContError = " ";
			if (isset($_POST['upstatus'])){
				if (empty($_POST["status"])){
					$ContError = "Please Write a status";
				}else{
					include('crud-app.php');
				}
			}
			...
			<div class="container">
				<div class="header-data">
					...
					<div class="user-account">
						<div class="user-info">
							<img src="<?php echo file_exists($pppp) ? $pppp : $path2; ?>" style="width: 25px;height: 25px;" alt="">
							<a href="#" title=""><?php echo $uname ?></a>
									...
									<div class="user-data full-width">
										<div class="user-profile">
											<div class="username-dt">
												<div class="usr-pic">
													<img src="<?php echo file_exists($pppp) ? $pppp : $path2; ?>" alt="">
												</div>
											</div><!--username-dt end-->
											<div class="user-specs">
												<h3><?php echo $fulname ?></h3>
							...
							<div class="col-lg-6 col-md-8 no-pd">
								<div class="main-ws-sec">
									<div class="post-topbar">
										...
										<div class="post-st">
											<ul>
												<li><a class="post_project" href="#" title="">Post a Status</a></li>
				...
				<div class="post-project-fields">
					<form method="POST" action="" enctype="Multpart/Form-data">
						<div class="row">
							...
							<div class="col-lg-12">
								<ul>
									<li><button class="active" type="submit" name="upstatus">Post</button></li>
